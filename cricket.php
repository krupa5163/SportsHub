    ...
    <div class="inner-information-text">
            <div class="container">
               ...
               <ul class="breadcrumb">
                  ...
                  <li class="active"><a href="#">bat</a></li>
                  <li class="active"><a href="#">ball</a></li> 
                  <li class="active"><a href="#">kit</a></li>
               </ul>
            </div>
         </div>
         ...
         <div class="row">
            <div class="container">
               <div class="col-md-3 column">
                  <div class="card">
                     <img class="img-responsive" src="image/cricket_bat.jpeg" alt="John" style="width:100%">
                     <div class="">
                        <h4>John Doe</h4>
               ...
               <div class="col-md-3 column">
                  <div class="card">
                     <img class="img-responsive" src="image/cricket2.jpeg" alt="Mike" style="width:100%">
                     <div class="">
                        <h4>Mike Ross</h4>
               ...
               <div class="col-md-3 column">
                  <div class="card">
                     <img class="img-responsive" src="image/cricket_bat1.jpeg" alt="John" style="width:100%">
                     <div class="">
                        <h4>John Doe</h4>
                        <p class="title">Designer</p>
                        <p>
               ...
               <div class="col-md-3 column">
                  <div class="card">
                     <img class="img-responsive" src="image/cricket4.jpeg" alt="Mike" style="width:100%">
                     <div class="">
                        <h4>Mike Ross</h4>
                        <p class="title">Art Director</p>
                        <p>
               ...
               <div class="col-md-3 column">
                  <div class="card">
                     <img class="img-responsive" src="image/cricket3.jpeg" alt="John" style="width:100%">
                     <div class="">
                        <h4>John Doe</h4>
                        <p class="title">Designer</p>
                        <p>
               ...
               <div class="col-md-3 column">
                  <div class="card">
                     <img class="img-responsive" src="image/cricket1.jpeg" alt="John" style="width:100%">
                     <div class="">
                        <h4>John Doe</h4>
                        <p class="title">Designer</p>
                        <p>
               ...
               <div class="col-md-3 column">
                  <div class="card">
                     <img class="img-responsive" src="image/cricket.jpeg" alt="John" style="width:100%">
                     <div class="">
                        <h4>John Doe</h4>
                        <p class="title">Designer</p>
                        <p>
