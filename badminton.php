         ...
         <div class="row">
            <div class="container">
               <div class="col-md-3 column">
                  <div class="card">
                     <img class="img-responsive" src="image/badminton8.jpeg" alt="racket" style="width:100%">
                     <div class="">
                        <h4> Single Badminton Racquet with Ultra Nylon
                             Shuttlecock Carrying Bag Included Badminton Kit</h4>
                        <p class="title">Color : Orange</p>
                        <p>
                        <div class="center"><button class="button">visit more</button></div>
                        </p>
                     </div>
                  </div>
               </div>
               <div class="col-md-3 column">
                  <div class="card">
                     <img class="img-responsive" src="image/badminton4.jpeg" alt="Mike" style="width:100%">
                     <div class="">
                        <h4></h4>
                        <p class="title">color : liyon</p>
                        <p>
                        <div class="center"><button class="button">visit more</button></div>
                        </p>
                     </div>
               ...
               <div class="col-md-3 column">
                  <div class="card">
                     <img class="img-responsive" src="image/badminton1.jpeg" alt="John" style="width:100%">
                     <div class="">
                        <h4>John Doe</h4>
                        <p class="title">color : multi color</p>
                        <p>
                        <div class="center"><button class="button">visit more</button></div>
                        </p>
                     </div>
               ...
               <div class="col-md-3 column">
                  <div class="card">
                     <img class="img-responsive" src="image/badminton7.jpeg" alt="John" style="width:100%">
                     <div class="">
                        <h4>John Doe</h4>
               ...
               <div class="col-md-3 column">
                  <div class="card">
                     <img class="img-responsive" src="image/badminton.jpeg" alt="Mike" style="width:100%">
                     <div class="">
                        <h4>Mike Ross</h4>
               ...
               <div class="col-md-3 column">
                  <div class="card">
                     <img class="img-responsive" src="image/badminton.5.jpeg" alt="John" style="width:100%">
                     <div class="">
                        <h4>John Doe</h4>
                        <p class="title">Designer</p>
                        <p>
